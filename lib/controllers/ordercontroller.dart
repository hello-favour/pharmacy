...
import 'package:pharmacy/services/orderservice.dart';
...
class OrderController extends StateNotifier<bool> {
  ...
  Future<void> createOrder(BuildContext context, String uid, UserModel user,
      AddressModel address, double total) async {
