...
import 'package:pharmacy/services/paymentservice.dart';

final paymentControllerProvider =
    StateNotifierProvider<PaymentController, bool>((ref) => PaymentController(
        paymentService: ref.watch(paymentServiceProvider), ref: ref));
...
class PaymentController extends StateNotifier<bool> {
  ...
  Future<void> createPayment(BuildContext context, String transactionId,
      double amount, String userId, String status) async {
