...
import 'package:pharmacy/apikeys/apikey.dart';
import 'package:pharmacy/controllers/paymentcontroller.dart';
...
class StripePaymentService {
  ...
  Future<void> makePayment(BuildContext context, double amount) async {
    try {
      ...
      paymentIntent =
          await createPaymentIntent(amount.toString(), 'USD', context);
      ...
      await Stripe.instance.initPaymentSheet(
        ...
        customerEphemeralKeySecret:
            paymentIntent!['ephemeralKey'], //Gotten from payment intent
      ...
      _ref.watch(paymentControllerProvider.notifier).createPayment(
          context,
          paymentIntent!['id'],
          amount,
          currentUser!.uid,
